...
def api_geohash():
    if 'geohash' in request.args and request.args['geohash'].isalnum():  # Check if a geohash was provided as part of the URL.
    ...
    return jsonify({"status": 200, "message": "success", "data": results})     # If geohash is provided, display its long and lat.
